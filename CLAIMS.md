...
### C1. The directory is skewed toward formal US/UK registry-visible organizations.

Status: supported
Confidence: high
Evidence: README directory breakdown, verified 2026-04-23: ~83% (21,559 of 26,022) of records come from US (IRS BMF) and UK (Charity Commission) open registries. The remaining 59 countries hold 4,463 records combined.
Falsifiers: A data audit showing comparable depth of non-US/UK informal and hybrid coverage (e.g. >5,000 records each from at least 5 non-US/UK countries with sourcing comparable to the US/UK rows).
Related files: README.md (What Exists Today), data/commonweave_directory.db, data/search/
Needed work: Legibility backfill (cw-legibility-backfill-001) and non-US/UK source expansion (cw-data-global-gap-001).
